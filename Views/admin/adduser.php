							...
							<div class="col-md-12">
								...
								<div class="box border green">
									...
									<div class="box-body big">
										<form role="form" method="POST" action="/dashboard/adduser" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="balance" required id="exampleInputPassword1" placeholder="Balance">
											</div>
