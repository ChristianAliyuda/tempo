							...
							<div class="col-md-12">
								...
								<div class="box border green">
									...
									<div class="box-body big">
										...
										<form role="form" method="POST" action="updatepassword" enctype="multipart/form-data">
                                        <?=csrf()?>
											...
											<div class="form-group">
												...
												<input type="password" class="form-control" required name="password"  id="exampleInputPassword1" placeholder="New Password">
											</div>

                                            <div class="form-group">
												<label for="exampleInputPassword1">Confirmation Password</label>
												<input type="password" class="form-control" required name="confirm_password" id="exampleInputPassword1" placeholder="Confirmation Password">
											</div>
