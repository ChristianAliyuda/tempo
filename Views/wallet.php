...
<body>
  ...
  <section class="container">
    <div class="btns">
      ...
      <div class="message1alert">
        <p>
          You can Not WithDraw Less Than 0.50 £
        </p>
        <button class="alertHide" onclick="hideAlert()">Ok</button>
      </div>
      ...
      <div class="message2alert">
        <p>
          You can Not WithDraw Less Than 1 £
        </p>
        <button class="alertHide" onclick="hideAlert()">Ok</button>
      </div>
      ...
      <div class="message3alert">
        <p>
          You can Not WithDraw Less Than 2 £
        </p>
        <button class="alertHide" onclick="hideAlert()">Ok</button>
      </div>
      ...
      <div class="message4alert">
        <p>
          You can Not WithDraw Less Than 3 £
        </p>
        <button class="alertHide" onclick="hideAlert()">Ok</button>
      </div>
  ...
  <main class="container">
    <div>
        ...
        <div class="balance">
          <h1 class="main_heading">Balance</h1>
          <h2 class="sub_heading" id="dollar"> <?= round($balance->current_amount,4) ?>£</h2>
          <button onclick="convertToPkr()" class="btn">Withdraw</button>
        </div>
    </div>
    <table>
      <tr>
        <th colspan="4">Withdraw History</th>
      </tr>
      <tr>
        <th></th>
        <th>Date</th>
      ...
      <?php $i=0;foreach ($payments as $payment) {  ?>
        <tr>
          ...
          <?php } ?>
          <td><?= $payment->amount * $settings->dollar_rate ?></td>
