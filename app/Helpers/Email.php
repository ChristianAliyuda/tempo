  ...
  protected $db;
	...
	public function sendForgetPasswordEmail($email){
	  ...
	  // $data['token']=123456;
	   ...
	   return $this->sendEmail($email,'Amadox Password Reset',$body);
	   //return true;
	}
	
	public function sendContactusEmail($name,$email,$message){
		$body=$this->contactusTemplate($name,$email,$message);
	   return $this->sendEmail('info@tikl.com','Horizam Contact Us Request',$body);
	}
	...
	public function  sendEmail($email,$subject,$body){
        ...
        $this->mail->setFrom($_ENV['MAIL_USERNAME'],"Amadox");
		$this->mail->addAddress($email);   
		
        $this->mail->isHTML(true);
        $this->mail->Subject = $subject;
        $this->mail->Body = $body;
        $this->mail->AltBody = "This is the Reset Password Email from Amadox";
        if(!$this->mail->send()) 
        {
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					2018 © Amadox ALL Rights Reserved.
				</span></font>				
			</td></tr>			
		</table>
	</td></tr>
